...
|--------|---------|-------------|
| research-tools | 1.5.0 | Multi-source web research & analysis - restaurant discovery, Wantedly/X(Twitter) developer recruitment, high-salary job search, 12-dimension company analysis, cross-site fact-checking |
...
| `company-analysis` | "〇〇社について調べて", "企業分析", "SWOT分析" | 3並列エージェントで12次元の包括的企業分析（概要/MVV/事業/市場/財務/経営陣/3C/強み/ニュース/採用/リスク/SWOT） |
